...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json(await getOwnPerformanceDashboard(actor, {
    ...
    return NextResponse.json({ success: false, error: "Não foi possível carregar sua Performance.", message: "Não foi possível carregar sua Performance." }, { status: 500 });
  }
}
