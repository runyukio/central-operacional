...
export const registrationPayloadSchema = z.object({
  ...
  password: z.string({ required_error: "Senha é obrigatória." }).min(8, "Senha deve ter pelo menos 8 caracteres.").max(128, "Senha deve ter no máximo 128 caracteres."),
  confirmPassword: z.string({ required_error: "Confirmação de senha é obrigatória." }).min(1, "Confirme a senha informada.").max(128),
