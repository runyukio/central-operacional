...
const permissionSeeds = [
  ...
  ["can_manage_schedules", "Gerenciar escalas"],
  ["can_import_schedules", "Importar escalas"],
  ["can_add_schedule_manually", "Adicionar escala manual"],
  ["can_edit_schedule_full", "Editar escala completa"],
