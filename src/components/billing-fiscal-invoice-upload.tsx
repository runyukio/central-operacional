      ...
      {displayed ? (
        <>
          <div className="grid gap-2 sm:grid-cols-3">
            ...
            <ReadField label="Valor bruto do Billing" value={formatCurrency(expectedGrossAmount)} />
          </div>
          <div className={cn(
            ...
            <span>
              {displayed.matchesBilling
                ? "Nota validada: o valor do serviço é igual ao valor bruto do Billing."
                : `Aprovação bloqueada: a nota está em ${formatCurrency(displayed.serviceAmount)} e o Billing em ${formatCurrency(expectedGrossAmount)}.`}
            </span>
          </div>
        </>
      ) : null}
