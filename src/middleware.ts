...
export const config = {
  matcher: ["/((?!api/auth|api/employee-registrations/public|api/realtime/import|api/realtime/fresh-chat/import|api/realtime/cec/import|api/realtime/ai-snapshot|api/realtime-hours/import|api/realtime-hours/agent-snapshot|api/realtime-hours/status|api/realtime-hours/imports|api/performance/import/automated|api/cron/realtime-cec|api/cron/realtime-fresh-chat|api/cron/ads-executive-report|cadastro-colaborador|login|_next/static|_next/image|favicon.ico).*)"]
};
